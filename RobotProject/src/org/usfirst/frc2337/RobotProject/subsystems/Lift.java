...
public class Lift extends PIDSubsystem {
    ...
    public Lift() {
        ...
        // Set the lift speed in prefs.
        
      // Preferences pref = liftPref.getInstance();
       //teleopMaxSpeedUp = pref.getDouble("teleopMaxSpeedUp", 0.65);
       //teleopMaxSpeedDown = pref.getDouble("teleopMaxSpeedDown", -0.6);


        
        if (competitionBot.get()) { 						//call method to set set-points based on DIO jumper        	
