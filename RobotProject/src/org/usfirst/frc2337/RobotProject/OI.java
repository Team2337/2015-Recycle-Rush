...
public class OI {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        autonChooser.addObject("Robot Set", 	new AutonDriveAtSpeedForTime(1, 5));
        autonChooser.addObject("1 Tote", 		new DoNothing());
        autonChooser.addObject("2 Tote Stack", 	new DoNothing());
        autonChooser.addObject("3 Tote Stack", 	new DoNothing());
        autonChooser.addObject("Container", 	new DoNothing());
        autonChooser.addObject("Test Command", 	new TestCommand());
