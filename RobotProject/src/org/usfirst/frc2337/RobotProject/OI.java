...
public class OI {
    ...
    public OI() {
        ...
        String pos1 = config.getSetting("position1");
        ...
        joystickDriverButtonA.whileHeld(new Positions(1.0, 3.8));
        ...
        SmartDashboard.putData("Position00", new Position00());

        SmartDashboard.putData("Position01", new Position01());

        SmartDashboard.putData("Position02", new Position02());

        SmartDashboard.putData("Position03", new Position03());

        SmartDashboard.putData("Position04", new Position04());

        SmartDashboard.putData("Position05", new Position05());

        SmartDashboard.putData("Position10", new Position10());

        SmartDashboard.putData("Position11", new Position11());

        SmartDashboard.putData("Position12", new Position12());

        SmartDashboard.putData("Position13", new Position13());

        SmartDashboard.putData("Position14", new Position14());

        SmartDashboard.putData("Position15", new Position15());

        SmartDashboard.putData("Position20", new Position20());

        SmartDashboard.putData("Position21", new Position21());

        SmartDashboard.putData("Position22", new Position22());

        SmartDashboard.putData("Position23", new Position23());

        SmartDashboard.putData("Position24", new Position24());

        SmartDashboard.putData("Position25", new Position25());
