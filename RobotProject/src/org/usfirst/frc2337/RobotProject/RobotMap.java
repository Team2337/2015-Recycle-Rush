...
public class RobotMap {
    ...
    static SerialPort gyro_serial_port;
    public static IMUAdvanced chassisgyro;
    public static boolean gyro_first_iteration;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        //Initialize the gyro
        try {
        	gyro_serial_port = new SerialPort(57600, SerialPort.Port.kOnboard);
        	
        	byte update_rate_hz = 50;
    		chassisgyro = new IMUAdvanced(gyro_serial_port, update_rate_hz);
        } catch(Exception ex) { }
        
        LiveWindow.addSensor("chassis", "Gyro", chassisgyro);
        gyro_first_iteration = true;
    }
}
