 ...
 *
 */
public class  INTAKE_CloseArmsAndPull extends Command {
	double left; //Left Motor
	double right; //Right Motor
	
    public INTAKE_CloseArmsAndPull(double left, double right) {
    ...
    protected void execute() {
    	...
    	//Robot.intakeOpen.setOpenArmPosition(false);
    	//Robot.intakePneumatics.setArmPosition(true);
   ...
   // 	Robot.intakeOpen.setOpenArmPosition(true);
    //[]\	Robot.intakePneumatics.setArmPosition(true);
