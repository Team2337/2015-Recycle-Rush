 ...
 */
public class  AutonStrafeAtSpeedForTime extends Command {
	private double strafeFactor;
	private double seconds;
	
    public AutonStrafeAtSpeedForTime(double strafeFactor, double seconds) {
    ...
    protected void execute() {
    	Robot.chassis.driveMecanum(0, strafeFactor, 0);
    }
