 ...
 */
public class Auton_Nested_A_WithContainerAndTurn extends CommandGroup {
	
    public  Auton_Nested_A_WithContainerAndTurn() {
    	...
    	addSequential(new Auton_Summary_TheBigFinishWithTurn());
