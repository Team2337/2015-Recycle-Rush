 ...
 *
 */
public class Auton_3ToteF_AfterKetteringWithToteB extends CommandGroup {
	
    public  Auton_3ToteF_AfterKetteringWithToteB() {
        // Add Commands here:
    ...
    //	addParallel(new KICKER_Kick());									//deploy kicker
    	...
    	addSequential(new Auton_ChassisPidSet(220));					//drive past container
