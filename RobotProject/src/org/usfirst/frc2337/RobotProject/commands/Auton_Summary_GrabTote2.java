...
public class Auton_Summary_GrabTote2 extends CommandGroup {
    ...
    public  Auton_Summary_GrabTote2() {
    	...
    	addSequential(new AutonEncoderStrafeIn(1, -15));    	
    	...
    	addSequential(new AutonWait(0.6));
    	...
    	addSequential(new AutonEncoderStrafeIn(1, -35));				//Changed 3/22 from -30    //Changed at kettering from -20
