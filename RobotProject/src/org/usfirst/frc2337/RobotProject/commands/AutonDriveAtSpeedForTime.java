 ...
 */
public class AutonDriveAtSpeedForTime extends Command {
	private double moveFactor;
	private double seconds;
	
    public AutonDriveAtSpeedForTime(double moveFactor, double seconds) {
    ...
    protected void execute() {
    	Robot.chassis.driveMecanum(moveFactor, 0, 0);
    }
