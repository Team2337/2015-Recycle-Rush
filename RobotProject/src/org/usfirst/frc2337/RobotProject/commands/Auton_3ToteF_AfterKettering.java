 ...
 *
 */
public class Auton_3ToteF_AfterKettering extends CommandGroup {
	
    public  Auton_3ToteF_AfterKettering() {
        // Add Commands here:
    ...
    //	addParallel(new KICKER_Kick());									//deploy kicker
    	...
    	addParallel(new Auton_ChassisPidSet(450));
    	addSequential(new Auton_LIFT_PidSet(Robot.lift.autonPos2));		//lower tote to pos 2 in parallel while driving to next tote
    	addSequential(new Auton_ChassisPidSet(527));					//drive to 2nd tote // from 510 at kettering  //527 at Kettering.
    	...
    	addSequential(new Auton_ChassisPidSet(320));					//Drive past container
    	...
    	addSequential(new Auton_ChassisPidSet(525));					//Drive to next tote
