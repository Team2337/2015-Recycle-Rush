 ...
 *
 */
public class Auton_3ToteE extends CommandGroup {
    ...
    public  Auton_3ToteE() {
    	...
    	addSequential(new Auton_LIFT_PidSet(Robot.lift.autonPos4));						//set down tote and get ready to pick up 2nd tote
       	addSequential(new AutonStrafeAtSpeedForTime(0.4, 0.6));		//nest totes
    	...
    	addSequential(new AutonStrafeAtSpeedForTime(-0.8, 0.6));	//strafe out to clear handle of can when driving forward
    	...
    	addSequential(new AutonStrafeAtSpeedForTime(0.8, 1.0));		//strafe in to set down tote 1 on tote 2
    	...
    	addSequential(new AutonStrafeAtSpeedForTime(0.8, 1.0));		//strafe into the auton zone
