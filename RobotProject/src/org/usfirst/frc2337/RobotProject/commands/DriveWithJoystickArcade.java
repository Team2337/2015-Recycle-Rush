...
/**
 * Drive with an arcade-style drive. The joystick is setup as a
 * "cheesy" control scheme. The left stick, up and down, is used
 * for driving and the right stick, left and right, is used for
 * rotation.
 */
public class  DriveWithJoystickArcade extends Command {
    ...
    protected void execute() {
        ...
        Robot.chassis.driveArcade(moveValue, rotateValue);
    }
