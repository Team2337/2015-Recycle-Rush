 ...
 */
public class  AutonDriveTurnStrafeForTime extends Command {
	private double driveFactor;
	private double turnFactor;
	private double strafeFactor;
	private double seconds;
	
    public AutonDriveTurnStrafeForTime(double driveFactor, double turnFactor, double strafeFactor, double seconds) {
    ...
    protected void execute() {
    	Robot.chassis.driveMecanum(driveFactor, strafeFactor, turnFactor);
    }
