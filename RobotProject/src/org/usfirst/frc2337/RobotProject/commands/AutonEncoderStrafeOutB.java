...
import org.usfirst.frc2337.RobotProject.RobotMap;
	 ...
	 */
	public class  AutonEncoderStrafeOutB extends Command {
		
		double speed;    	//negative is towards totes/auton zone
		int distance;		//Auton zone is approx 975 ticks
		private double gyroValue;
		private double kP = .03;  
		private double driveValue,driveGoal;
		

		
	    public AutonEncoderStrafeOutB(double speed, int distance) {
	    ...
	    protected void initialize() {
	    	...
	    	driveGoal = Robot.chassis.readAutonEncoder();
	    }

	    // Called repeatedly when this Command is scheduled to run
	    protected void execute() {
	    	
	    	driveValue = (driveGoal - Robot.chassis.readAutonEncoder());
	    	...
	    	Robot.chassis.driveMecanum(driveValue, speed, gyroValue);
	    }
