 ...
 *
 */
public class CopyOfAuton_3ToteG extends CommandGroup {
	
    public  CopyOfAuton_3ToteG() {
        // Add Commands here:
    	...
    	addSequential(new AutonStrafeAtSpeedForTimeGyro(-0.5, 0.7));	//strafe out to clear handle of can when driving forward
