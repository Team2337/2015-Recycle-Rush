 ...
 *
 */
public class Auton_3ToteF_AfterKetteringWithTote extends CommandGroup {
	
    public  Auton_3ToteF_AfterKetteringWithTote() {
        // Add Commands here:
    ...
    //	addParallel(new KICKER_Kick());									//deploy kicker
    	...
    	addParallel(new Auton_ChassisPidSetWithToteSensor(450));
