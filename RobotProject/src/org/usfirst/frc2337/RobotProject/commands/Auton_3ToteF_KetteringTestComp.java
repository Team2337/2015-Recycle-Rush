 ...
 *
 */
public class Auton_3ToteF_KetteringTestComp extends CommandGroup {
	
    public  Auton_3ToteF_KetteringTestComp() {
        // Add Commands here:
    	...
    	addSequential(new Auton_ChassisPidSet(527));					//drive to 2nd tote // from 510 at kettering
